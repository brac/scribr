...
draft: true
summary: "Phase 1 builds the /log index, per-project listings, nine RSS feeds, sitemap, and canonicals, working around an Astro trailing-slash bug in feed endpoints."
repo_ref: "phase-1"
decisions:
